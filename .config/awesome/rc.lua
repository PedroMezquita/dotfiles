...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, }, "l", function () awful.spawn(lockscreen) end,
    	       {description = "Locks the screen with i3lock", group = "screen"}),
    awful.key({ modkey, "Shift" }, "s", function () awful.spawn("flameshot gui") end,
    		{description = "Launches the screen capture selection", group = "screen"}),
    awful.key({ modkey, }, "Print", function () awful.spawn("flameshot launcher") end,
    		{description = "Captures whole screen", group = "screen"}),
    awful.key({ }, "Print", function () awful.spawn("flameshot screen --clipboard") end,
    		{description = "Captures screen to clipboard", group = "screen"}),
    ...
    awful.key({ modkey, "Shift" }, "Return", function () awful.spawn('rofi -show drun') end,
    		{description = "runs rofi to launch an application", group = "launcher"}),
